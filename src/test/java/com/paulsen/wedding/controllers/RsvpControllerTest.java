...
public class RsvpControllerTest {
  ...
  public void testCreateRsvp() throws Exception {
    ...
    mockMvc.perform(
            post("/rsvp/create").contentType(MediaType.APPLICATION_JSON).content(jsonRequest))
  ...
  public void testSubmitRsvp() throws Exception {
    ...
    mockMvc.perform(
            post("/rsvp/submit").contentType(MediaType.APPLICATION_JSON).content(jsonRequest))
        .andExpect(status().isOk())
  ...
  public void testLookup() throws Exception {
    ...
    mockMvc.perform(
            post("/rsvp/lookup").contentType(MediaType.APPLICATION_JSON).content(jsonRequest))
        .andExpect(status().isOk())
  ...
  public void testAddGuest() throws Exception {
    ...
    mockMvc.perform(
            post("/rsvp/guest/add").contentType(MediaType.APPLICATION_JSON).content(jsonRequest))
        .andExpect(status().isOk())
  ...
  public void testRemoveGuest() throws Exception {
    ...
    mockMvc.perform(
            post("/rsvp/guest/remove").contentType(MediaType.APPLICATION_JSON).content(jsonRequest))
        .andExpect(status().isOk())
  ...
  public void testGetAllGuests() throws Exception {
    ...
    mockMvc.perform(get("/rsvp/guest/all"))
        .andExpect(status().isOk())
        .andExpect(
            jsonPath("$[0].fullName").value(StringFormatUtil.formatToIndexName("John", "Doe")))
        .andExpect(
            jsonPath("$[1].fullName").value(StringFormatUtil.formatToIndexName("Jane", "Doe")));
  }
}
