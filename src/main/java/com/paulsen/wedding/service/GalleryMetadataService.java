...
public class GalleryMetadataService {
  ...
  @Transactional
  public ImageMetadata saveImageMetadata(String imageId, String imageUrl, int width, int height,
      long uploadTimestamp) {
    ImageMetadata max = imageMetadataRepository.findFirstByPartitionOrderByOrderValueDesc(
            ImageMetadata.PARTITION)
        .orElse(null);
  ...
  @Transactional
  public void changeImageOrder(String movingImageId, String previousImageId,
      String followingImageId) {
  ...
  public void delete(String imageId) {
    imageMetadataRepository.getImageMetadataByImageId(imageId)
