...
public class RsvpGuestDetails {
  ...
  @DynamoDBAttribute(attributeName = "coming")
  ...
  public RsvpGuestDetails(String displayName) {
    this(displayName, List.of(), "", true);
  }

  public RsvpGuestDetails(String displayName, List<DietaryRestriction> dietaryRestrictions,
      String other, boolean coming) {
