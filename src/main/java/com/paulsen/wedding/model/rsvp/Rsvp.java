...
@DynamoDBTable(tableName = "wedding_rsvp_table")
public class Rsvp {
  ...
  @DynamoDBAttribute(attributeName = "guest_list")
  @DynamoDBTypeConverted(converter = RsvpGuestDetailsMapConverter.class)
  private Map<String, RsvpGuestDetails> guestList;

  @DynamoDBAttribute(attributeName = "roce")
  @DynamoDBTypeConverted(converter = EventConverter.class)
  private Event roce;

  @DynamoDBAttribute(attributeName = "rehearsal")
  @DynamoDBTypeConverted(converter = EventConverter.class)
  private Event
      rehearsal;

  @DynamoDBAttribute(attributeName = "ceremony")
  @DynamoDBTypeConverted(converter = EventConverter.class)
  private Event
      ceremony;

  @DynamoDBAttribute(attributeName = "reception")
  @DynamoDBTypeConverted(converter = EventConverter.class)
  private Event
      reception;
  ...
  @DynamoDBIgnore
  @JsonIgnore
  public Set<String> getNamesInEvents() {
    Set<String> names = new HashSet<>();

    for (Event event : getNonNullEvents()) {
      names.addAll(event.getGuestsAttending());
    }
