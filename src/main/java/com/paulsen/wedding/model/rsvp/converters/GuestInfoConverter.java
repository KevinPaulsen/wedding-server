...
public class GuestInfoConverter extends ConverterBase
  ...
  @Override
  public AttributeValue convert(WeddingPrimaryContact guestInfo) {
    AttributeValue name = new AttributeValue().withS(
        Objects.requireNonNullElse(guestInfo.getName(), ""));
    AttributeValue phone = new AttributeValue().withS(
        Objects.requireNonNullElse(guestInfo.getPhoneNumber(), ""));
    AttributeValue email = new AttributeValue().withS(
        Objects.requireNonNullElse(guestInfo.getEmail(), ""));
    AttributeValue address = new AttributeValue().withS(
        Objects.requireNonNullElse(guestInfo.getAddress(), ""));
  ...
  @Override
  public WeddingPrimaryContact unconvert(AttributeValue object) {
